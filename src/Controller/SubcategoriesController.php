...
class SubcategoriesController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Subcategories->save($subcategory)) {
                $this->Flash->success('The subcategory has been saved.');
                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error('The subcategory could not be saved. Please, try again.');
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Subcategories->delete($subcategory)) {
            $this->Flash->success('The subcategory has been deleted.');
        } else {
            $this->Flash->error('The subcategory could not be deleted. Please, try again.');
        }
        return $this->redirect(['action' => 'index']);
    }
}
